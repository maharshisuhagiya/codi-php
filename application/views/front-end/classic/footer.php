...
<div id="modal-custom" class="auth-modal" data-iziModal-group="group1">
    ...
    <section class="hide" id="login_div">
        <form action="<?= base_url('home/login') ?>" class='form-submit-event' id="login_form" method="post">
            ...
            <div align="center"><a href="<?=$google_client->createAuthUrl()?>"><img src="<?=base_url()?>assets/sign-in-with-google.png" /></a> </div></br></br>
            <footer>
    ...
    <section id="register_div">
        <form id='send-otp-form' class='send-otp-form d-none' action='#'>
        ...
        <form id='verify-otp-form' class='verify-otp-form ' action='<?= base_url('auth/register-user') ?>' method="POST">
            <div class="row sign-up-verify-number">
                <!--<div class="col-12 d-flex justify-content-center pb-4">-->
                <!--    <input type="text" class='form-input' placeholder="OTP" id="otp" name="otp" autocomplete="off">-->
                <!--</div>-->
                <div class="col-12 d-flex justify-content-center pb-4">
                    <input type="text" class='form-input' placeholder="First name" id="firstname" name="firstname">
                </div>
                <div class="col-12 d-flex justify-content-center pb-4">
                    <input type="text" class='form-input' placeholder="Last name" id="lastname" name="lastname">
                </div>
                <div class="col-12 d-flex justify-content-center pb-4">
